...
else if(group==='browser')for(const name of ['focus-audio','prologue','epilogue','homing-jaw','encounter-speech','ravil-battle','department','jump-audio'])run('tests/'+name+'.cjs');
